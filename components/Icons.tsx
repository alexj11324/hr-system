...
export const BrandSymbol = ({ className = "w-10 h-10" }: { className?: string }) => (
  <div className={`flex-shrink-0 flex items-center justify-center rounded-full bg-[#EF4444] ${className}`}>
...
export const BrandLogo = ({ className = "", textClassName = "text-gray-900", symbolSize = "w-8 h-8" }: { className?: string, textClassName?: string, symbolSize?: string }) => (
  <div className={`flex items-center gap-3 ${className}`}>
    <BrandSymbol className={symbolSize} />
    <span className={`text-xl font-bold tracking-tight ${textClassName}`}>CardioGuard</span>
  </div>
);
...
export const PieChartIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
...
export const RotateCwIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
